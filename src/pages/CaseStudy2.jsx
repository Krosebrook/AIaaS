...
export default function CaseStudy2() {
  ...
  useScrollRestoration('case-study-2');
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8">
            ...
            <p className="text-signal-white/80">
              This project leveraged our <span className="font-semibold text-int-orange">Custom AI Solution Design</span> service
            </p>
          </div>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link
              to={createPageUrl('Contact?service=Custom AI Solution Design')}
