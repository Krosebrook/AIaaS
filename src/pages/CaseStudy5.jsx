...
import { DollarSign, ArrowLeft, Clock, TrendingUp, Users } from 'lucide-react';
...
export default function CaseStudy5() {
  const study = {
    ...
    challenge: 'AR team overwhelmed with manual follow-ups, inconsistent messaging, and poor collection rates. Staff spent 75% of their time on repetitive communication tasks instead of strategic relationship management, leading to extended payment cycles and customer frustration.',
    solution: 'Deployed AI-powered AR automation with personalized messaging and payment prediction. Built intelligent system that analyzes customer payment patterns, crafts personalized follow-up messages, and prioritizes outreach based on likelihood to pay.',
    results: [
      '75% reduction in manual AR tasks',
      '40% faster payment cycles',
      'Professional, personalized communications',
      'Improved customer relationships and satisfaction',
      'Predictive payment modeling deployed',
      'Zero complaints about collection tactics'
    ],
    metrics: {
      timeSaved: '30 hours/week',
      roi: '410%',
      implementation: '6 weeks',
      improvement: '40% faster cycles'
    },
    testimonial: {
      quote: "Our AR team finally has time to handle exceptions and build relationships. The AI handles routine follow-ups better than we ever could manually, and customers actually appreciate the professional, timely communication.",
      author: "CFO"
    }
  };

  const Icon = study.icon;
  useScrollRestoration('case-study-5');
      ...
      <section className="py-8 px-6 bg-gradient-to-r from-flash-purple/10 to-fusion-pink/10 border-b border-flash-purple/30">
        <div className="max-w-6xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-6">
          ...
          <div className="text-center">
            ...
            <div className="text-2xl font-bold text-fusion-pink mb-1">{study.metrics.improvement}</div>
            <div className="text-sm text-signal-white/60">Payment Speed</div>
          </div>
        </div>
      </section>
              ...
              <div className="p-8 bg-carbon-night rounded-2xl border-2 border-ember-red/50 h-full">
                <div className="aspect-video bg-gradient-to-br from-ember-red/20 to-void rounded-lg mb-6 flex items-center justify-center">
                  <div className="text-center p-6">
                    ...
                    <div className="text-sm text-signal-white/60">Manual AR chaos</div>
                  </div>
                </div>
                <ul className="space-y-3 text-sm">
                  <li className="flex items-start gap-2 text-ember-red"><span className="mt-1">✗</span><span>Overwhelming manual follow-ups</span></li>
                  <li className="flex items-start gap-2 text-ember-red"><span className="mt-1">✗</span><span>Inconsistent messaging</span></li>
                  <li className="flex items-start gap-2 text-ember-red"><span className="mt-1">✗</span><span>Slow payment cycles</span></li>
                  <li className="flex items-start gap-2 text-ember-red"><span className="mt-1">✗</span><span>Customer frustration</span></li>
                </ul>
              </div>
            </div>
            <div className="relative">
              ...
              <div className="p-8 bg-carbon-night rounded-2xl border-2 border-neon-mint/50 h-full">
                <div className="aspect-video bg-gradient-to-br from-neon-mint/20 to-void rounded-lg mb-6 flex items-center justify-center">
                  <div className="text-center p-6">
                    <div className="text-6xl mb-4">🎯</div>
                    <div className="text-sm text-signal-white/60">Smart automation</div>
                  </div>
                </div>
                <ul className="space-y-3 text-sm">
                  <li className="flex items-start gap-2 text-neon-mint"><span className="mt-1">✓</span><span>75% task automation</span></li>
                  <li className="flex items-start gap-2 text-neon-mint"><span className="mt-1">✓</span><span>Personalized communications</span></li>
                  <li className="flex items-start gap-2 text-neon-mint"><span className="mt-1">✓</span><span>40% faster payments</span></li>
                  <li className="flex items-start gap-2 text-neon-mint"><span className="mt-1">✓</span><span>Improved relationships</span></li>
                </ul>
              </div>
            </div>
          </div>
